...
import flatbuffers from flatbuffers.compat import import_numpy np = import_numpy()
    ...
    class Color(object) : __slots__ =['_tab']
...
#Color
                                                                                                                                                                                                                                                                                                           def A(self) : return self._tab.Get(flatbuffers.number_types.Uint8Flags, self._tab.Pos + flatbuffers.number_types.UOffsetTFlags.py_type(3))
                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                       def CreateColor(builder, r, g, b, a) : builder.Prep(1, 4) builder.PrependUint8(a) builder.PrependUint8(b) builder.PrependUint8(g) builder.PrependUint8(r) return builder.Offset()
